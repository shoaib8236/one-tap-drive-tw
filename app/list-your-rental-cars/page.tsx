      ...
      <Section>
        <Container>
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mt-12">
            <div className="p-5">
              <p>
                Join OneTapDrive to profit from over 1 million page views every
                month, with more than 50,000 quality leads sent to car rental
                companies and brokers all across the world.
              </p>
              <ul>
                <li className="mb-2">
                  <p className="ml-0 mb-2 flex items-center gap-4">
                    <FaCheck className="text-primary min-w-[16px]" /> Get direct
                    leads via phone, SMS and emails.
                  </p>
                </li>
                <li className="mb-2">
                  <p className="ml-0 mb-2 flex items-center gap-4">
                    <FaCheck className="text-primary min-w-[16px]" /> Full
                    training provided for your staff to use the CMS.
                  </p>
                </li>
                <li className="mb-2">
                  <p className="ml-0 mb-2 flex items-center gap-4">
                    <FaCheck className="text-primary min-w-[16px]" /> Assistance
                    from your dedicated Account Manager.
                  </p>
                </li>
                <li className="mb-2">
                  <p className="ml-0 mb-2 flex items-center gap-4">
                    <FaCheck className="text-primary min-w-[16px]" /> Tools and
                    resources to plan your marketing strategy.
                  </p>
                </li>
                <li className="mb-2">
                  <p className="ml-0 mb-2 flex items-center gap-4">
                    <FaCheck className="text-primary min-w-[16px]" /> Exclusive
                    member benefits
                  </p>
                </li>
              </ul>
